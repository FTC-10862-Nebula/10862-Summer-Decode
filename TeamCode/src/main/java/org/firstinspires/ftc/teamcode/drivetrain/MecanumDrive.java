...
public final class MecanumDrive {
    ...
    public MecanumDrive() {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "lF"); //leftBack
        leftBack = hardwareMap.get(DcMotorEx.class, "lB"); //leftBack
        rightBack = hardwareMap.get(DcMotorEx.class, "rB"); //rB
        rightFront = hardwareMap.get(DcMotorEx.class, "rF"); //rF
